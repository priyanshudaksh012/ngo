...
<body>
    ...
    <nav class="navigation">
        <div class="navigation__menu">
            ...
            <a href="contact.php" class="navigation__menu--link selected paragraph--5">contact us</a>
        </div>
    </nav>
   ...
   <div class="mobmenu">
    ...
    <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!    BANNER      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
    <div class="banner">
        <h5 class="heading--5 banner__heading">Get In Touch</h5>
    </div>
    <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!    CONTACT      !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
    <div class="contact">
        <form action="#" class="contact__form">
            <h4 class="heading--4 contact__heading">Send us Message</h4>
            <p class="paragraph--4 contact__paragraph contact__name">Name*</p>
            ...
            <p class="paragraph--4 contact__paragraph contact__subject">Subject*</p>
            <input type="text" id="subject" class="text paragraph--4 contact__subject">
            <p class="paragraph--4 contact__paragraph contact__message">Messge*</p>
            <textarea id="message" class="textarea paragraph--4 contact__message"></textarea>
            <button type="submit" class="button contact__button">
                Submit
            </button>
        </form>
        <div class="contact__details">
            <h4 class="heading--4 contact__heading">Get in Touch</h4>
            <p class="paragraph--4 contact__strong">Address:</p>
            <p class="paragraph--4 contact__paragraph">
                Green Mount Landour Cantt Mussoorie,<br>
                 Dehradun, India
            </p>
            <p class="paragraph--4 contact__strong">Email:</p>
            <a href="mailto:info@sgi.foundation" class="paragraph--4 contact__link">
                info@sgi.foundation
            </a>
            <p class="paragraph--4 contact__strong">Tel:</p>
            <a href="tel:+918449950998" class="paragraph--4 contact__link">
                +91 9730330053
            </a>
        </div>
    </div>
